...
public class BruteForceTest {
	...
	public void test() {
		...
		// TEST
		expectedCM = new ConfusionMatrix(4, 15, 5, 0, 24);
		...
		// TEST
		expectedCM = new ConfusionMatrix(4, 20, 0, 0, 24);
		filename1 = "examples/mini.mn";
		...
		// TEST
		expectedCM = new ConfusionMatrix(9, 15, 0, 0, 24);
	...
	public void testTemplate(ConfusionMatrix expectedCM, String filename1,
		...
		ConfusionMatrix cm = BruteForce.computeConfusionMatrix(model1, model2,
				n, true);
